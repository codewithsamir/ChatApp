...
import {  forgotpasswordActive, loginActive, signupActive } from "@/Ruduxtoolkit/registerSlice"
// import Image from "next/image"
...
const Login = () => {
 ...
 const dispatch = useDispatch()
  ...
  <div className="main w-full fixed left-0 right-0 top-0 bottom-0 backdrop-blur-md z-50">
    ...
    <h2 className="text-center font-bold  text-white text-3xl mb-5">Login</h2>
     <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
       ...
       <Button type="submit" className="w-full bg-white hover:bg-blue-900 hover:text-white text-xl font-normal text-black ">Submit</Button>
       </div>
    ...
    className="text-white text-lg">forgot password</Button>
    </div>
    <div className="btn pt-2">
       <Button  className="w-full bg-transparent hover:text-black border-2 border-pink-600 hover:bg-white sm:text-xl hover:border-none">Login with Google 
    ...
    <div className="btn pt-2  sm:flex gap-1  justify-center items-center ">
       ...
       className="text-orange-500 text-lg p-0">Create New Account</Button>
       </div>
    </Form>
   </div>
  </div>
