...
import {   loginActive, signupActive } from "@/Ruduxtoolkit/registerSlice"
...
<GiCrossMark className="text-3xl text-white cursor-pointer hover:text-red-500 absolute right-4 top-4" 
    ...
    <div className="btn pt-2  sm:flex gap-1  justify-center items-center">
        <p className="text-lg text-white">Already have  account? </p>
       <Button variant={"link"} 
       onClick = {()=>{
        dispatch(signupActive(false))
        dispatch(loginActive(true))
       }}
       className="text-orange-500 text-lg p-0"> Log in</Button>
       </div>
